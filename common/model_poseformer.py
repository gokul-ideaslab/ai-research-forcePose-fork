...
class PoseTransformer(nn.Module):
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
                 ...
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.2,  norm_layer=None, pred_force=False, multitask=False):
        ...
        out_dim_force = 6 #6-axis grf prediction
        ...
        self.head_grf = nn.Sequential(
            nn.LayerNorm(embed_dim),
            nn.Linear(embed_dim, out_dim_force),
        )
